//
//  PPAVAssetExportSession.m
//
// This file is part of the PPAVAssetExportSession package.
//
...
@interface PPAVAssetExportSession ()
...
@implementation PPAVAssetExportSession
{
    NSError *_error;
...
{
    return [PPAVAssetExportSession.alloc initWithAsset:asset];
}
...
- (AVMutableVideoComposition *)buildDefaultVideoComposition
{
	...
	// Workaround radar 31928389, see https://github.com/rs/PPAVAssetExportSession/pull/70 for more info
	if (transform.ty == -560) {
		transform.ty = 0;
	}
