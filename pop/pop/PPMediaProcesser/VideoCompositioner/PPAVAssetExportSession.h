...
@protocol PPAVAssetExportSessionDelegate;
...
@interface PPAVAssetExportSession : NSObject

@property (nonatomic, weak) id<PPAVAssetExportSessionDelegate> delegate;
...
@protocol PPAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(AVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
